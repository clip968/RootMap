...
## Corpus Check
- 126 files · ~79,030 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2084 nodes · 5006 edges · 143 communities (139 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 35 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `056ef2ae`
...
Cohesion: 0.08
Nodes (57): CompleteUploadRequest, POST(), startDocumentProcessingJob(), ALLOWED_DOCUMENT_MIME_TYPES, documentTitleFromFilename(), EXECUTABLE_EXTENSIONS, EXECUTABLE_MIME_PREFIXES, extensionOf() (+49 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (66): Admin Concepts Screen, Chunk Concept Extraction, Chunking, Concept Detail Panel, Concept Edges, Concept Merge Candidates, Concept REST API, Concept Reuse (+58 more)
...
Cohesion: 0.1
Nodes (40): bodySchema, llmErrorResponse(), POST(), bodySchema, POST(), calculateRetrievability(), clampRange(), FsrsLiteGrade (+32 more)

### Community 5 - "Community 5"
Cohesion: 0.09
Nodes (34): buildFlowElements(), compareNodeKeys(), confidencePercent(), DocumentEvidenceItem, documentSourceTypeLabel(), documentSourceTypeTone(), edgeClassForNodeType(), edgeColorForNodeType() (+26 more)

### Community 6 - "Community 6"
Cohesion: 0.11
Nodes (33): clearDocumentProcessingJobsForTests(), createQueuePayload(), DocumentLookup, DocumentProcessingJob, DocumentProcessingJobStatus, DocumentProcessingWorkerResult, DocumentProcessingWorkerStatus, DocumentProcessor (+25 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (31): analyzeWeakConcepts(), buildDeterministicSessionReport(), buildSessionReportUserMessage(), collectSessionReportInput(), createSessionLearningReport(), eventConceptTitles(), generateSessionReportWithLlm(), mergeSessionReport() (+23 more)
...
Cohesion: 0.13
Nodes (34): getDb(), documentChunks, documentConcepts, documentLearningTrees, documentPages, documents, bulkInsertDocumentChunks(), bulkInsertDocumentConcepts() (+26 more)
...
Cohesion: 0.14
Nodes (29): communityMembers, conceptCommunities, conceptEdges, conceptMergeCandidates, concepts, learningNodes, learningTrees, userConceptProgress (+21 more)
...
Cohesion: 0.22
Nodes (26): baseSlugFromNormalizedTitle(), normalizeTitle(), RootMapDbClient, learningTreeConcepts, Ctx, GET(), POST(), postSchema (+18 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (31): bundle, chunks, created, db, dbAbs, dbRel, detail, docConcepts (+23 more)
...
Cohesion: 0.12
Nodes (28): Ctx, GET(), loadMasteryMap(), toPersonalizedNodeInputs(), buildNextActions(), buildPersonalizedNodes(), calculateNodeRecommendationScore(), collectActionableCandidateKeys() (+20 more)

### Community 17 - "Community 17"
Cohesion: 0.14
Nodes (29): ChatMessage, assembleLearningTree(), ChatCompletionRunner, classifyLlmError(), DETAIL_PHASES, DetailPhase, fallbackConceptCandidate(), GenerateLearningTreeOptions (+21 more)
...
Cohesion: 0.18
Nodes (18): bodySchema, Ctx, POST(), LlmExhaustedRetriesError, LlmParseError, LlmTransportError, buildGenerateNodeDetailUserMessage(), generateNodeDetail() (+10 more)

### Community 21 - "Community 21"
Cohesion: 0.2
Nodes (21): Ctx, POST(), ConceptRow, getConceptById(), DocumentTreeNodeContext, findDocumentContextForNode(), getLearningTree(), LearningNodeRow (+13 more)
...
Cohesion: 0.08
Nodes (25): 17. 품질 기준, 18. 최소 품질 기준, 1. Phase 4 목표, 1순위, 20. 구현 우선순위, 21. 보안 및 개인정보 고려, 22. Phase 4 완료 조건, 2. Phase 4의 위치 (+17 more)
...
Cohesion: 0.14
Nodes (21): Ctx, GET(), getDocumentForUser(), listDocumentConceptsForUser(), assert(), checkQuality(), db, dbAbs (+13 more)
...
Cohesion: 0.2
Nodes (14): createRequestId(), logGenerateRoute(), POST(), InvalidTopicError, LlmValidationError, generateLearningTree(), formatConceptsForPrompt(), searchConceptsForPromptContext() (+6 more)

### Community 30 - "Community 30"
Cohesion: 0.14
Nodes (17): getSqlClient(), globalForDb, resetDbSingleton(), resolvePostgresConnectionString(), RootMapDb, RootMapSqlClient, RootMapTx, assert() (+9 more)

### Community 31 - "Community 31"
Cohesion: 0.15
Nodes (20): DocumentTreeContext, LearningTreeBundle, ApiTreeResponse, ApiLearningNode, ApiPersonalizedNode, ApiPersonalizedRecommendationItem, ApiPersonalizedRecommendationsResponse, ApiPersonalizedTreeResponse (+12 more)

### Community 32 - "Community 32"
Cohesion: 0.17
Nodes (17): DetailLearningBlocks(), DetailLearningBlocksProps, firstSentence(), shortLabel(), byId, graph, nodes, ApiNodeDetailResponse (+9 more)

### Community 33 - "Community 33"
Cohesion: 0.1
Nodes (20): 12. LLM 출력 스키마 변경, 17. 품질 기준, 19. 구현 우선순위, 1. Phase 2 목표, 1순위, 20. Phase 2 완료 조건, 21. Phase 2의 핵심 판단 기준, 2. Phase 2의 위치 (+12 more)
...
Cohesion: 0.33
Nodes (12): buildChunk(), chunkFromPdfPages(), chunkFromText(), ChunkInput, chunkUnits(), estimateTokens(), getOverlapUnits(), parseMarkdownHeadings() (+4 more)

### Community 40 - "Community 40"
Cohesion: 0.23
Nodes (14): updateDocumentExtractedInfo(), assert(), createTestPdf(), db, dbAbs, dbRel, extractAndChunkDocument(), ExtractSmokeError (+6 more)
...
Cohesion: 0.36
Nodes (13): assert(), assertAllNodesLinked(), attentionFamilyTree(), bertTree(), cleanupSmokeDb(), EdgeSpec, main(), node() (+5 more)
...
Cohesion: 0.2
Nodes (9): CommunityLearningPathAction, CommunityLearningPathInput, ConceptGraphEdgeInput, DuplicateConceptScore, DuplicateConceptScoreInput, DuplicateConceptSignalInput, overlapRatio(), roundScore() (+1 more)
...
Cohesion: 0.18
Nodes (11): Document Chunking, Document Concept Evidence, Document Concept Extraction, document_concepts Table, Document Upload, PDF Text Extraction, Phase 3 Document Based Learning, Turn Documents Into Learning Paths Rather Than Summaries (+3 more)
...
Cohesion: 0.25
Nodes (7): code:sql (notify pgrst, 'reload schema';), code:bash (npm run phase6:security-preflight), Deployment Runbook, Environment Targets, Phase 06 Gates, Supabase, Vercel
...
Cohesion: 0.38
Nodes (6): bodySchema, Ctx, paramsSchema, POST(), readOptionalJson(), endLearningSession()

### Community 86 - "Community 86"
Cohesion: 0.52
Nodes (5): Ctx, GET(), PATCH(), patchSchema, updateConceptPatch()
...
Cohesion: 0.29
Nodes (7): AI Wiki Internal Knowledge Graph, Concept Aware Tree Generation, Concept Edge, Concept Node, Karpathy LLM Wiki, Phase 2 Concept Node Store, Store Concepts Once and Reuse Across Topics

### Community 95 - "Community 95"
Cohesion: 0.33
Nodes (5): Assets, Controls, Residual Risks, RootMap Security Threat Model, Trust Boundaries

### Community 96 - "Community 96"
Cohesion: 0.33
Nodes (5): Failure Rules, Procedure, Required Environment, RLS Test Plan, Target Policy

### Community 97 - "Community 97"
Cohesion: 0.33
Nodes (5): Current Rule, Full Eval, LLM Evaluation, Scope, Small CI Eval
...
Cohesion: 0.4
Nodes (4): Current Model, FSRS-lite Rule v1, Learning Science Rationale, Long-term Direction
...
Cohesion: 0.67
Nodes (3): 23. Phase 4의 핵심 판단 기준, code:text (사용자가 무엇을 이미 아는지 반영된다.), code:text (모든 사용자에게 같은 추천을 한다.)
...
## Knowledge Gaps
- **611 isolated node(s):** `UiRecommendationItem`, `ReportConceptContext`, `ReportLearningEventInput`, `ReportMasteryRecordInput`, `ReportQuizAttemptInput` (+606 more)
...
- **Why does `getDb()` connect `Community 9` to `Community 0`, `Community 2`, `Community 4`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 21`, `Community 24`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 40`, `Community 43`, `Community 55`, `Community 85`, `Community 86`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `jsonError()` connect `Community 0` to `Community 2`, `Community 4`, `Community 11`, `Community 13`, `Community 16`, `Community 20`, `Community 85`, `Community 86`, `Community 21`, `Community 24`, `Community 27`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `ProgressStatus` connect `Community 24` to `Community 5`, `Community 7`, `Community 11`, `Community 12`, `Community 15`, `Community 16`, `Community 26`, `Community 31`?**
