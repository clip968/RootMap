...
## Corpus Check
- 105 files · ~66,033 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1823 nodes · 4503 edges · 112 communities (108 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2e375541`
...
1. `getDb()` - 106 edges
2. `jsonError()` - 70 edges
3. `getLearningTree()` - 35 edges
...
Cohesion: 0.05
Nodes (77): Home(), DetailLearningBlocks(), DetailLearningBlocksProps, firstSentence(), GenerationLoadingPanel(), GenerationLoadingPanelProps, waitHint(), ALLOWED_DOCUMENT_EXTENSIONS (+69 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (78): AuthenticatedUserResult, AuthenticationFailureResult, authFailure(), extractBearerToken(), getSupabaseAuthApiKey(), getSupabaseUrl(), inferSupabaseUrlFromDatabaseUrl(), isUuid() (+70 more)
...
Cohesion: 0.15
Nodes (38): CompleteUploadRequest, POST(), ALLOWED_DOCUMENT_MIME_TYPES, documentTitleFromFilename(), EXECUTABLE_EXTENSIONS, EXECUTABLE_MIME_PREFIXES, extensionOf(), isAllowedMime() (+30 more)
...
Cohesion: 0.15
Nodes (24): Ctx, GET(), Ctx, GET(), Ctx, POST(), ApiErrorBody, jsonError() (+16 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (35): Ctx, GET(), listConcepts(), listDocumentConceptsForUser(), bundle, chunks, created, db (+27 more)

### Community 10 - "Community 10"
Cohesion: 0.16
Nodes (33): baseSlugFromNormalizedTitle(), normalizeTitle(), RootMapDbClient, communityMembers, conceptCommunities, conceptEdges, conceptMergeCandidates, concepts (+25 more)
...
Cohesion: 0.14
Nodes (28): getDb(), learningNodes, learningTrees, userConceptProgress, bodySchema, Ctx, PATCH(), createLearningNodes() (+20 more)

### Community 14 - "Community 14"
Cohesion: 0.14
Nodes (25): Ctx, GET(), PATCH(), patchSchema, AdminConceptsPage(), firstParam(), isAdminRouteEnabled(), PageProps (+17 more)
...
Cohesion: 0.18
Nodes (21): ConceptRow, findDocumentContextForNode(), LearningNodeRow, saveNodeDetail(), assert(), main(), node(), setupDb() (+13 more)
...
Cohesion: 0.12
Nodes (24): resetDbSingleton(), assert(), dbAbs, dbRel, main(), requireOpenRouterEnv(), assert(), checkQuality() (+16 more)

### Community 20 - "Community 20"
Cohesion: 0.19
Nodes (23): ChatMessage, assembleLearningTree(), ChatCompletionRunner, classifyLlmError(), DETAIL_PHASES, DetailPhase, fallbackConceptCandidate(), GenerateLearningTreeOptions (+15 more)
...
Cohesion: 0.11
Nodes (21): afterPrereqs, apiPayload, assert(), assertExpectedConcepts(), assertPrerequisiteOrder(), assertTreeQuality(), { bundle, recommended }, countByType() (+13 more)
...
Cohesion: 0.3
Nodes (10): ApiTreePayload, ChunkConceptCandidate, ConceptCandidate, ConceptRelationType, DocumentConceptType, DocumentConsolidationResponse, DocumentTreeNode, DocumentTreeStructureNode (+2 more)
...
Cohesion: 0.36
Nodes (7): assert(), calls, completion(), detailFor(), json(), main(), outline
...
## Knowledge Gaps
- **498 isolated node(s):** `LearningEventType`, `INITIAL_CONFIDENCE_BY_STATUS`, `SelfAssessmentResult`, `LearningSessionRow`, `LearningEventRow` (+493 more)
...
- **Why does `getDb()` connect `Community 13` to `Community 0`, `Community 34`, `Community 2`, `Community 4`, `Community 35`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 14`, `Community 16`, `Community 19`, `Community 22`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `jsonError()` connect `Community 8` to `Community 2`, `Community 4`, `Community 6`, `Community 9`, `Community 11`, `Community 13`, `Community 14`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `RootMap Phase 4 명세서` connect `Community 21` to `Community 96`, `Community 67`, `Community 38`, `Community 74`, `Community 75`, `Community 80`, `Community 81`, `Community 18`, `Community 87`, `Community 88`, `Community 25`, `Community 27`, `Community 61`?**
