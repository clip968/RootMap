...
## Corpus Check
- 110 files · ~68,494 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1865 nodes · 4660 edges · 126 communities (121 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 32 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8e777bce`
...
1. `getDb()` - 109 edges
2. `jsonError()` - 76 edges
3. `getLearningTree()` - 38 edges
4. `createChatCompletion()` - 35 edges
5. `getDocumentForUser()` - 31 edges
6. `processDocument()` - 29 edges
7. `getConceptById()` - 27 edges
8. `LlmParseError` - 27 edges
9. `LlmValidationError` - 26 edges
...
Cohesion: 0.05
Nodes (104): getDb(), documentChunks, documentConcepts, documentLearningTrees, documentPages, documents, buildChunk(), chunkFromPdfPages() (+96 more)
...
Cohesion: 0.15
Nodes (43): llmProviderSettings, buildLlmProviderHeaders(), envJsonMode(), getEnvLlmProviderStatus(), getLlmProviderMaxAttempts(), getLlmProviderStatus(), getLlmProviderTimeoutMs(), LlmProviderStatus (+35 more)

### Community 5 - "Community 5"
Cohesion: 0.1
Nodes (40): communityMembers, conceptCommunities, conceptEdges, conceptMergeCandidates, concepts, learningNodes, learningTrees, userConceptProgress (+32 more)

### Community 6 - "Community 6"
Cohesion: 0.11
Nodes (40): generateDocumentNodeDetail(), logGenerate(), shouldAbortRetries(), parseDocumentNodeDetailResponse(), sliceBalancedJsonObject(), stripLlmFences(), buildDocumentNodeDetailUserMessage(), chunkConceptCandidateSchema (+32 more)
...
Cohesion: 0.15
Nodes (21): bodySchema, Ctx, POST(), createRequestId(), logGenerateRoute(), POST(), InvalidTopicError, LlmExhaustedRetriesError (+13 more)
...
Cohesion: 0.06
Nodes (32): learningEvents, learningReports, learningSessions, misconceptionEvents, quizAttempts, recommendationLogs, userConceptMastery, AppendLearningEventInput (+24 more)
...
Cohesion: 0.14
Nodes (29): buildFlowElements(), compareNodeKeys(), DocumentEvidenceItem, documentSourceTypeLabel(), documentSourceTypeTone(), edgeClassForNodeType(), edgeColorForNodeType(), FOCUS_OPTIONS (+21 more)
...
Cohesion: 0.08
Nodes (25): 17. 품질 기준, 18. 최소 품질 기준, 1. Phase 4 목표, 1순위, 20. 구현 우선순위, 21. 보안 및 개인정보 고려, 22. Phase 4 완료 조건, 23. Phase 4의 핵심 판단 기준 (+17 more)
...
Cohesion: 0.22
Nodes (18): GenerateDocumentNodeDetailInput, GenerateDocumentNodeDetailResult, ConceptRow, DocumentTreeNodeContext, findDocumentContextForNode(), LearningNodeRow, saveNodeDetail(), buildPanelGraph() (+10 more)

### Community 23 - "Community 23"
Cohesion: 0.17
Nodes (19): applySelfAssessment(), clampScore(), convertScoreToStatus(), INITIAL_CONFIDENCE_BY_STATUS, initialConfidenceForStatus(), MasteryStatus, SelfAssessmentResult, shouldNeedReview() (+11 more)
...
Cohesion: 0.28
Nodes (13): Ctx, POST(), jsonError(), recommendNextNodes(), Ctx, GET(), getDocumentTreeContextForUser(), getConceptProgressMapForUser() (+5 more)

### Community 27 - "Community 27"
Cohesion: 0.18
Nodes (17): bodySchema, llmErrorResponse(), POST(), Ctx, ensureConcept(), GET(), getOrCreateMastery(), masteryResponse() (+9 more)

### Community 28 - "Community 28"
Cohesion: 0.24
Nodes (16): ChatMessage, ChatRole, createChatCompletion(), getOpenRouterMaxAttempts(), getOpenRouterTimeoutMs(), OpenRouterChatCompletionResponse, OpenRouterChoiceMessage, classifyLlmError() (+8 more)
...
Cohesion: 0.24
Nodes (10): Ctx, GET(), Ctx, GET(), POST(), getDocumentForUser(), getDocumentLearningTreeForUser(), listDocumentConceptsForUser() (+2 more)
...
Cohesion: 0.22
Nodes (9): assert(), assertConcurrencyLimit(), assertThrows(), documentNodes, DocumentRecommendNode, ids, lowQualityTree, recommendedIds() (+1 more)
...
Cohesion: 0.42
Nodes (7): byDifficultyAsc(), byDocumentOrderThenDifficulty(), RecommendNextOptions, RecommendNodeInput, ApiRecommendationItem, DocumentNodeType, DocumentSourceType
...
Cohesion: 0.54
Nodes (6): bodySchema, Ctx, PATCH(), getNodeById(), upsertNodeProgress(), upsertUserConceptProgress()
...
Cohesion: 0.38
Nodes (3): listLearningTreeHistory(), Ctx, GET()
...
Cohesion: 0.6
Nodes (4): DetailLearningBlocks(), DetailLearningBlocksProps, firstSentence(), ApiNodeDetailResponse
...
## Knowledge Gaps
- **509 isolated node(s):** `LearningEventType`, `QuizEvaluationInput`, `QuizEvaluationResult`, `QuizMasteryState`, `quizEvaluationSchema` (+504 more)
...
- **Why does `getDb()` connect `Community 0` to `Community 3`, `Community 4`, `Community 5`, `Community 9`, `Community 10`, `Community 16`, `Community 19`, `Community 20`, `Community 22`, `Community 24`, `Community 26`, `Community 27`, `Community 30`, `Community 36`, `Community 39`, `Community 44`, `Community 48`, `Community 63`, `Community 77`, `Community 85`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `jsonError()` connect `Community 26` to `Community 0`, `Community 3`, `Community 4`, `Community 36`, `Community 8`, `Community 77`, `Community 16`, `Community 20`, `Community 85`, `Community 27`, `Community 30`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `RootMap Phase 4 명세서` connect `Community 17` to `Community 33`, `Community 101`, `Community 102`, `Community 70`, `Community 42`, `Community 76`, `Community 15`, `Community 83`, `Community 84`, `Community 117`, `Community 91`, `Community 92`, `Community 31`?**
...
- **What connects `LearningEventType`, `QuizEvaluationInput`, `QuizEvaluationResult` to the rest of the system?**
