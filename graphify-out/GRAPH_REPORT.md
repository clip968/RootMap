...
## Corpus Check
- 108 files · ~67,556 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1849 nodes · 4585 edges · 132 communities (127 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `750df61c`
...
1. `getDb()` - 107 edges
2. `jsonError()` - 73 edges
3. `getLearningTree()` - 38 edges
4. `createChatCompletion()` - 34 edges
5. `getDocumentForUser()` - 31 edges
6. `processDocument()` - 29 edges
7. `LlmParseError` - 26 edges
8. `getConceptById()` - 25 edges
9. `LlmTransportError` - 25 edges
10. `LlmValidationError` - 25 edges
...
Cohesion: 0.14
Nodes (48): ChatRole, createChatCompletion(), getOpenRouterTimeoutMs(), OpenRouterChatCompletionResponse, OpenRouterChoiceMessage, buildChatCompletionsUrl(), buildLlmProviderHeaders(), envJsonMode() (+40 more)
...
Cohesion: 0.15
Nodes (40): CompleteUploadRequest, POST(), ALLOWED_DOCUMENT_MIME_TYPES, documentTitleFromFilename(), EXECUTABLE_EXTENSIONS, EXECUTABLE_MIME_PREFIXES, extensionOf(), isAllowedMime() (+32 more)
...
Cohesion: 0.12
Nodes (29): Ctx, GET(), PATCH(), patchSchema, AdminConceptsPage(), firstParam(), isAdminRouteEnabled(), PageProps (+21 more)
...
Cohesion: 0.12
Nodes (33): sliceBalancedJsonObject(), stripLlmFences(), chunkConceptCandidateSchema, chunkConceptExtractionResponseSchema, conceptCandidateSchema, conceptRelationSchema, consolidatedConceptEvidenceSchema, consolidatedConceptSchema (+25 more)
...
Cohesion: 0.17
Nodes (27): getDb(), bulkInsertDocumentChunks(), bulkInsertDocumentPages(), CreateDocumentInput, createDocumentLearningTreeLink(), DOCUMENT_CONCEPT_TYPE_ORDER, DocumentChunkInput, DocumentConceptEvidenceResponse (+19 more)
...
Cohesion: 0.16
Nodes (21): bodySchema, Ctx, paramsSchema, POST(), readOptionalJson(), bodySchema, POST(), isLearningEventType() (+13 more)

### Community 21 - "Community 21"
Cohesion: 0.08
Nodes (24): 17. 품질 기준, 18. 최소 품질 기준, 1. Phase 4 목표, 21. 보안 및 개인정보 고려, 22. Phase 4 완료 조건, 23. Phase 4의 핵심 판단 기준, 2. Phase 4의 위치, 3. Phase 4 범위 (+16 more)
...
Cohesion: 0.15
Nodes (19): documentChunks, documentPages, ensurePdfJsTextExtractionPolyfills(), extractPdfPages(), loadPdfJs(), PdfPage, readPdfFile(), assert() (+11 more)
...
Cohesion: 0.19
Nodes (17): applySelfAssessment(), INITIAL_CONFIDENCE_BY_STATUS, initialConfidenceForStatus(), MasteryStatus, SelfAssessmentResult, shouldNeedReview(), Ctx, ensureConcept() (+9 more)
...
Cohesion: 0.22
Nodes (12): generateLearningTree(), formatConceptsForPrompt(), searchConceptsForPromptContext(), createFullLearningTree(), assert(), main(), node(), setupDb() (+4 more)

### Community 31 - "Community 31"
Cohesion: 0.23
Nodes (14): DetailLearningBlocks(), DetailLearningBlocksProps, firstSentence(), ApiNodeDetailResponse, ApiLearningNode, ApiTreePayload, ChunkConceptCandidate, ConceptRelationType (+6 more)
...
Cohesion: 0.2
Nodes (15): clampScore(), convertScoreToStatus(), calculateNodeRecommendationScore(), collectActionableCandidateKeys(), DEFAULT_MASTERY, defaultImportance(), generateRecommendationReasons(), isMastered() (+7 more)

### Community 34 - "Community 34"
Cohesion: 0.22
Nodes (15): communityMembers, conceptCommunities, conceptEdges, conceptMergeCandidates, concepts, documentConcepts, documentLearningTrees, documents (+7 more)
...
Cohesion: 0.16
Nodes (17): Concept Aware Tree Generation, Concept Detail Panel, Concept Edge, Concept Edges, Concept Node, Concept REST API, Concept Reuse Indicators, Learning Tree Concepts (+9 more)
...
Cohesion: 0.15
Nodes (13): AI Wiki Internal Knowledge Graph, Document Chunking, Document Concept Evidence, Document Concept Extraction, document_concepts Table, Document Upload, Karpathy LLM Wiki, PDF Text Extraction (+5 more)
...
Cohesion: 0.27
Nodes (11): AuthenticatedUserResult, AuthenticationFailureResult, authFailure(), extractBearerToken(), getSupabaseAuthApiKey(), getSupabaseUrl(), inferSupabaseUrlFromDatabaseUrl(), isUuid() (+3 more)
...
Cohesion: 0.36
Nodes (9): Ctx, GET(), loadMasteryMap(), toPersonalizedNodeInputs(), buildPersonalizedNodes(), PersonalizedMasteryState, PersonalizedNodeInput, createRecommendationLog() (+1 more)
...
Cohesion: 0.38
Nodes (8): LlmTransportError, generateNodeDetail(), GenerateNodeDetailInput, GenerateNodeDetailResult, shouldAbortRetries(), parseNodeDetailResponse(), buildNodeDetailUserMessage(), nodeDetailQualityWarnings()
...
Cohesion: 0.7
Nodes (3): Ctx, GET(), getDocumentConceptEvidenceForUser()
...
Cohesion: 0.4
Nodes (5): Admin Concepts Screen, Concept Merge Candidates, Concept Reuse, Duplicate Concept Detection, 10 Admin And Phase2 Quality Tests Plan
...
## Knowledge Gaps
- **503 isolated node(s):** `LearningEventType`, `INITIAL_CONFIDENCE_BY_STATUS`, `SelfAssessmentResult`, `PersonalizedScoringContext`, `PersonalizedNodeResult` (+498 more)
...
- **Why does `getDb()` connect `Community 15` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 18`, `Community 20`, `Community 22`, `Community 23`, `Community 25`, `Community 28`, `Community 29`, `Community 30`, `Community 48`, `Community 60`, `Community 92`, `Community 98`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `jsonError()` connect `Community 2` to `Community 0`, `Community 98`, `Community 4`, `Community 7`, `Community 12`, `Community 13`, `Community 60`, `Community 18`, `Community 20`, `Community 28`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `RootMap Phase 4 명세서` connect `Community 21` to `Community 96`, `Community 97`, `Community 32`, `Community 36`, `Community 104`, `Community 105`, `Community 74`, `Community 47`, `Community 80`, `Community 19`, `Community 116`, `Community 89`, `Community 90`?**
...
- **What connects `LearningEventType`, `INITIAL_CONFIDENCE_BY_STATUS`, `SelfAssessmentResult` to the rest of the system?**
