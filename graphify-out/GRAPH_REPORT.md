...
## Corpus Check
- 103 files · ~65,204 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1805 nodes · 4437 edges · 123 communities (119 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `36c8f2af`
...
8. `LlmTransportError` - 25 edges
9. `LlmValidationError` - 25 edges
10. `LlmExhaustedRetriesError` - 25 edges
...
Cohesion: 0.05
Nodes (105): documentChunks, documentConcepts, documentLearningTrees, documentPages, documents, buildChunk(), chunkFromPdfPages(), chunkFromText() (+97 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (69): AuthenticatedUserResult, AuthenticationFailureResult, authFailure(), extractBearerToken(), getSupabaseAuthApiKey(), getSupabaseUrl(), inferSupabaseUrlFromDatabaseUrl(), isUuid() (+61 more)
...
Cohesion: 0.11
Nodes (40): LearningTreeDetailResponse, LearningTreeOutlineResponse, parseDocumentTreeStructureResponse(), parseJsonObject(), parseLearningTreeDetailResponse(), parseLearningTreeOutlineResponse(), parseLearningTreeResponse(), sliceBalancedJsonObject() (+32 more)
...
Cohesion: 0.15
Nodes (22): bodySchema, Ctx, POST(), createRequestId(), logGenerateRoute(), POST(), InvalidTopicError, LlmExhaustedRetriesError (+14 more)
...
Cohesion: 0.21
Nodes (28): baseSlugFromNormalizedTitle(), normalizeTitle(), RootMapDbClient, communityMembers, conceptCommunities, conceptEdges, conceptMergeCandidates, concepts (+20 more)

### Community 10 - "Community 10"
Cohesion: 0.14
Nodes (26): Ctx, POST(), GenerateDocumentNodeDetailInput, GenerateDocumentNodeDetailResult, ConceptRow, DocumentTreeNodeContext, getLearningTree(), LearningNodeRow (+18 more)
...
Cohesion: 0.14
Nodes (24): Home(), GenerationLoadingPanel(), GenerationLoadingPanelProps, waitHint(), ALLOWED_DOCUMENT_EXTENSIONS, apiErrorMessage(), DocumentConceptsResponse, DocumentConceptSummary (+16 more)

### Community 13 - "Community 13"
Cohesion: 0.18
Nodes (24): getDb(), userConceptProgress, userNodeProgress, bodySchema, Ctx, PATCH(), createLearningNodes(), createLearningTree() (+16 more)

### Community 14 - "Community 14"
Cohesion: 0.22
Nodes (21): CompleteUploadRequest, POST(), ALLOWED_DOCUMENT_MIME_TYPES, documentTitleFromFilename(), EXECUTABLE_EXTENSIONS, EXECUTABLE_MIME_PREFIXES, extensionOf(), isAllowedMime() (+13 more)
...
Cohesion: 0.22
Nodes (14): Ctx, GET(), Ctx, GET(), jsonError(), POST(), getDocumentForUser(), getDocumentLearningTreeForUser() (+6 more)
...
Cohesion: 0.2
Nodes (19): byDifficultyAsc(), byDocumentOrderThenDifficulty(), RecommendNextOptions, RecommendNodeInput, DocumentTreeContext, ApiLearningNode, ApiProgressEntry, ApiRecommendationItem (+11 more)
...
Cohesion: 0.09
Nodes (21): 17. 품질 기준, 18. 최소 품질 기준, 21. 보안 및 개인정보 고려, 22. Phase 4 완료 조건, 23. Phase 4의 핵심 판단 기준, 2. Phase 4의 위치, 3. Phase 4 범위, 4. Phase 3와 Phase 4의 차이 (+13 more)
...
Cohesion: 0.32
Nodes (17): authHeaders(), createSignedDocumentUpload(), downloadDocumentObject(), encodeObjectPath(), getDocumentStorageBucket(), getSupabaseServiceRoleKey(), getSupabaseUrl(), inferSupabaseUrlFromDatabaseUrl() (+9 more)
...
Cohesion: 0.23
Nodes (17): Concept Store, Document Based Learning Tree, Document Concept Resolution, Document Concepts, Document Query APIs, Document Recommendation Logic, Document Upload Result UI, Evidence (+9 more)
...
Cohesion: 0.2
Nodes (14): Chunk Concept Extraction, Chunking, Document Chunks, Document Concept Integration, Document Learning Trees, Document LLM Schemas, Document Pages, Document Processing Pipeline (+6 more)
...
Cohesion: 0.17
Nodes (12): Document Node Detail, Document Tree UI, Perceived Performance Wait UI, RootMap Phase 2.5 Implementation Plan README, 04 Tree Generation Latency And Perceived Performance Plan, 01 Tree View Layout Plan, 02 Tree View Polish And Quality Plan, 09 Document Tree And Node Detail UI Plan (+4 more)
...
## Knowledge Gaps
- **494 isolated node(s):** `LearningEventType`, `LearningSessionRow`, `LearningEventRow`, `UserConceptMasteryRow`, `QuizAttemptRow` (+489 more)
...
- **Why does `getDb()` connect `Community 13` to `Community 0`, `Community 1`, `Community 2`, `Community 36`, `Community 6`, `Community 10`, `Community 44`, `Community 14`, `Community 17`, `Community 50`, `Community 18`, `Community 20`, `Community 23`, `Community 89`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `jsonError()` connect `Community 17` to `Community 0`, `Community 1`, `Community 2`, `Community 36`, `Community 6`, `Community 7`, `Community 10`, `Community 13`, `Community 14`, `Community 20`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `getDocumentForUser()` connect `Community 17` to `Community 0`, `Community 5`, `Community 6`, `Community 44`, `Community 13`, `Community 89`?**
...
- **What connects `LearningEventType`, `LearningSessionRow`, `LearningEventRow` to the rest of the system?**
