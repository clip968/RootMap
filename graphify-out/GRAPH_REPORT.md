...
## Corpus Check
- 114 files · ~72,953 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1938 nodes · 4825 edges · 123 communities (119 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 35 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `88928489`
...
Cohesion: 0.12
Nodes (44): CompleteUploadRequest, POST(), ALLOWED_DOCUMENT_MIME_TYPES, documentTitleFromFilename(), EXECUTABLE_EXTENSIONS, EXECUTABLE_MIME_PREFIXES, extensionOf(), isAllowedMime() (+36 more)
...
Cohesion: 0.1
Nodes (38): bodySchema, llmErrorResponse(), POST(), applySelfAssessment(), clampScore(), convertScoreToStatus(), INITIAL_CONFIDENCE_BY_STATUS, initialConfidenceForStatus() (+30 more)

### Community 8 - "Community 8"
Cohesion: 0.12
Nodes (37): parseJsonObject(), parseLearningTreeDetailResponse(), parseLearningTreeOutlineResponse(), parseLearningTreeResponse(), parseNodeDetailResponse(), chunkConceptCandidateSchema, chunkConceptExtractionResponseSchema, conceptCandidateSchema (+29 more)
...
Cohesion: 0.15
Nodes (34): asRecord(), buildDocumentEvidence(), ChunkCandidateBatch, ChunkConceptCandidate, ChunkConceptExtractionMetadata, clampDocumentScore(), conceptCandidateFromDocumentConcept(), consolidateConcepts() (+26 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (34): learningEvents, learningReports, learningSessions, misconceptionEvents, quizAttempts, recommendationLogs, userConceptMastery, AppendLearningEventInput (+26 more)
...
Cohesion: 0.12
Nodes (30): documentChunks, documentConcepts, documentLearningTrees, documentPages, documents, CreateDocumentInput, createDocumentLearningTreeLink(), DOCUMENT_CONCEPT_TYPE_ORDER (+22 more)

### Community 15 - "Community 15"
Cohesion: 0.13
Nodes (24): DetailLearningBlocks(), DetailLearningBlocksProps, firstSentence(), DocumentTreeContext, ApiNodeDetailResponse, ApiTreeResponse, ApiLearningNode, ApiPersonalizedNode (+16 more)

### Community 16 - "Community 16"
Cohesion: 0.17
Nodes (22): Ctx, POST(), ConceptRow, getLearningTree(), LearningNodeRow, saveNodeDetail(), assert(), main() (+14 more)

### Community 17 - "Community 17"
Cohesion: 0.17
Nodes (17): bodySchema, Ctx, POST(), createRequestId(), logGenerateRoute(), POST(), InvalidTopicError, LlmExhaustedRetriesError (+9 more)

### Community 18 - "Community 18"
Cohesion: 0.15
Nodes (27): ChatMessage, assembleLearningTree(), ChatCompletionRunner, classifyLlmError(), DETAIL_PHASES, DetailPhase, fallbackConceptCandidate(), GenerateLearningTreeOptions (+19 more)

### Community 19 - "Community 19"
Cohesion: 0.18
Nodes (23): getDb(), bodySchema, Ctx, PATCH(), createLearningNodes(), createLearningTree(), FullTreeOptions, getConceptTreeUsageCounts() (+15 more)

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (28): 17. 품질 기준, 18. 최소 품질 기준, 1. Phase 4 목표, 1순위, 20. 구현 우선순위, 21. 보안 및 개인정보 고려, 22. Phase 4 완료 조건, 23. Phase 4의 핵심 판단 기준 (+20 more)
...
Cohesion: 0.1
Nodes (19): 12. LLM 출력 스키마 변경, 15. 사용자 진행 상태 확장, 1. Phase 2 목표, 20. Phase 2 완료 조건, 21. Phase 2의 핵심 판단 기준, 2. Phase 2의 위치, 3. Phase 2 범위, 4. Phase 1과 Phase 2의 차이 (+11 more)
...
Cohesion: 0.2
Nodes (18): bulkInsertDocumentChunks(), bulkInsertDocumentPages(), nowIso(), updateDocumentExtractedInfo(), updateDocumentStatus(), assert(), createTestPdf(), db (+10 more)

### Community 33 - "Community 33"
Cohesion: 0.24
Nodes (12): Ctx, GET(), POST(), getDocumentForUser(), getDocumentLearningTreeForUser(), getDocumentTreeContextForUser(), listDocumentConceptsForUser(), bundleToApiTreeResponse() (+4 more)
...
Cohesion: 0.22
Nodes (14): bodySchema, POST(), isLearningEventType(), LEARNING_EVENT_TYPES, LearningEventType, toIsoString(), appendLearningEvent(), getDocumentAccessForUser() (+6 more)
...
## Knowledge Gaps
- **530 isolated node(s):** `UiRecommendationItem`, `ReportConceptContext`, `ReportLearningEventInput`, `ReportMasteryRecordInput`, `ReportQuizAttemptInput` (+525 more)
...
- **Why does `getDb()` connect `Community 19` to `Community 1`, `Community 3`, `Community 4`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 16`, `Community 22`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 32`, `Community 33`, `Community 35`, `Community 43`, `Community 46`, `Community 52`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `jsonError()` connect `Community 25` to `Community 1`, `Community 33`, `Community 35`, `Community 3`, `Community 4`, `Community 7`, `Community 10`, `Community 43`, `Community 16`, `Community 17`, `Community 19`, `Community 22`, `Community 26`, `Community 27`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `ProgressStatus` connect `Community 22` to `Community 4`, `Community 5`, `Community 7`, `Community 12`, `Community 15`, `Community 19`, `Community 26`, `Community 28`?**
