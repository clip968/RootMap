...
## Corpus Check
- 112 files · ~69,078 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1879 nodes · 4695 edges · 122 communities (118 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 32 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cfebf18a`
...
Cohesion: 0.05
Nodes (102): documentChunks, documentConcepts, documentLearningTrees, documentPages, documents, userNodeProgress, buildChunk(), chunkFromPdfPages() (+94 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (74): baseSlugFromNormalizedTitle(), normalizeTitle(), AdminConceptsPage(), firstParam(), isAdminRouteEnabled(), PageProps, short(), StatusBadge() (+66 more)
...
Cohesion: 0.13
Nodes (43): CompleteUploadRequest, POST(), ALLOWED_DOCUMENT_MIME_TYPES, documentTitleFromFilename(), EXECUTABLE_EXTENSIONS, EXECUTABLE_MIME_PREFIXES, extensionOf(), isAllowedMime() (+35 more)
...
Cohesion: 0.12
Nodes (31): buildFlowElements(), compareNodeKeys(), DocumentEvidenceItem, documentSourceTypeLabel(), documentSourceTypeTone(), edgeClassForNodeType(), edgeColorForNodeType(), FOCUS_OPTIONS (+23 more)
...
Cohesion: 0.14
Nodes (30): ChatMessage, assembleLearningTree(), ChatCompletionRunner, classifyLlmError(), DETAIL_PHASES, DetailPhase, fallbackConceptCandidate(), GenerateLearningTreeOptions (+22 more)
...
Cohesion: 0.12
Nodes (27): applySelfAssessment(), clampScore(), convertScoreToStatus(), INITIAL_CONFIDENCE_BY_STATUS, initialConfidenceForStatus(), MasteryStatus, SelfAssessmentResult, shouldNeedReview() (+19 more)
...
Cohesion: 0.22
Nodes (21): getDb(), bodySchema, Ctx, PATCH(), createLearningNodes(), createLearningTree(), FullTreeOptions, getConceptTreeUsageCounts() (+13 more)
...
Cohesion: 0.16
Nodes (21): Ctx, GET(), loadMasteryMap(), toPersonalizedNodeInputs(), buildPersonalizedNodes(), calculateNodeRecommendationScore(), collectActionableCandidateKeys(), DEFAULT_MASTERY (+13 more)
...
Cohesion: 0.21
Nodes (16): LearningNodeRow, assert(), main(), node(), setupDb(), buildPanelGraph(), buildPrerequisitePromptContext(), documentContextToApi() (+8 more)

### Community 24 - "Community 24"
Cohesion: 0.23
Nodes (14): Ctx, POST(), Ctx, GET(), findDocumentContextForNode(), getDocumentTreeContextForUser(), getConceptProgressMapForUser(), getLearningTree() (+6 more)

### Community 25 - "Community 25"
Cohesion: 0.09
Nodes (21): 17. 품질 기준, 18. 최소 품질 기준, 1. Phase 4 목표, 21. 보안 및 개인정보 고려, 22. Phase 4 완료 조건, 23. Phase 4의 핵심 판단 기준, 2. Phase 4의 위치, 4. Phase 3와 Phase 4의 차이 (+13 more)

### Community 26 - "Community 26"
Cohesion: 0.16
Nodes (18): byDifficultyAsc(), byDocumentOrderThenDifficulty(), recommendNextNodes(), RecommendNextOptions, RecommendNodeInput, assert(), assertConcurrencyLimit(), assertThrows() (+10 more)
...
Cohesion: 0.19
Nodes (16): bodySchema, llmErrorResponse(), POST(), Ctx, ensureConcept(), GET(), getOrCreateMastery(), masteryResponse() (+8 more)
...
Cohesion: 0.22
Nodes (14): AuthenticatedUserResult, AuthenticationFailureResult, authFailure(), extractBearerToken(), getSupabaseAuthApiKey(), getSupabaseUrl(), inferSupabaseUrlFromDatabaseUrl(), isUuid() (+6 more)
...
Cohesion: 0.33
Nodes (9): ApiTreePayload, ChunkConceptCandidate, ConceptRelationType, DocumentTreeNode, DocumentTreeResponse, DocumentTreeStructureNode, LearningTreeNode, LearningTreeResponse (+1 more)
...
Cohesion: 0.43
Nodes (4): listTreesUsingConcept(), listLearningTreeHistory(), Ctx, GET()
...
## Knowledge Gaps
- **513 isolated node(s):** `LearningEventType`, `QuizEvaluationInput`, `QuizEvaluationResult`, `QuizMasteryState`, `quizEvaluationSchema` (+508 more)
...
- **Why does `getDb()` connect `Community 17` to `Community 0`, `Community 1`, `Community 33`, `Community 3`, `Community 36`, `Community 69`, `Community 5`, `Community 9`, `Community 43`, `Community 11`, `Community 15`, `Community 18`, `Community 19`, `Community 21`, `Community 23`, `Community 24`, `Community 29`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `jsonError()` connect `Community 15` to `Community 33`, `Community 3`, `Community 36`, `Community 69`, `Community 5`, `Community 7`, `Community 17`, `Community 18`, `Community 19`, `Community 24`, `Community 29`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `RootMap Phase 4 명세서` connect `Community 25` to `Community 96`, `Community 97`, `Community 67`, `Community 41`, `Community 73`, `Community 107`, `Community 16`, `Community 113`, `Community 82`, `Community 81`, `Community 87`, `Community 88`, `Community 30`, `Community 31`?**
