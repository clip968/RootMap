...
## Corpus Check
- 115 files · ~73,155 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1941 nodes · 4836 edges · 128 communities (124 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 35 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f7f1a37a`
...
1. `getDb()` - 113 edges
2. `jsonError()` - 81 edges
3. `getLearningTree()` - 40 edges
4. `createChatCompletion()` - 36 edges
5. `getDocumentForUser()` - 31 edges
6. `processDocument()` - 29 edges
7. `LlmParseError` - 28 edges
8. `getConceptById()` - 27 edges
9. `LlmValidationError` - 27 edges
10. `requireSupabaseAuthUserId()` - 26 edges
...
- `main()` --calls--> `getDb()`  [EXTRACTED]
  scripts/smoke-document-detail.ts → apps/web/src/db/client.ts
...
Cohesion: 0.05
Nodes (69): Admin Concepts Screen, Chunk Concept Extraction, Chunking, Concept Aware Tree Generation, Concept Detail Panel, Concept Edge, Concept Edges, Concept Merge Candidates (+61 more)

### Community 1 - "Community 1"
Cohesion: 0.14
Nodes (49): llmProviderSettings, ChatRole, createChatCompletion(), getOpenRouterTimeoutMs(), OpenRouterChatCompletionResponse, OpenRouterChoiceMessage, buildChatCompletionsUrl(), buildLlmProviderHeaders() (+41 more)
...
Cohesion: 0.07
Nodes (43): byDifficultyAsc(), byDocumentOrderThenDifficulty(), recommendNextNodes(), RecommendNextOptions, RecommendNodeInput, Ctx, GET(), getConceptProgressMapForUser() (+35 more)

### Community 4 - "Community 4"
Cohesion: 0.14
Nodes (39): CompleteUploadRequest, POST(), ALLOWED_DOCUMENT_MIME_TYPES, documentTitleFromFilename(), EXECUTABLE_EXTENSIONS, EXECUTABLE_MIME_PREFIXES, extensionOf(), isAllowedMime() (+31 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (38): bodySchema, Ctx, paramsSchema, POST(), readOptionalJson(), analyzeWeakConcepts(), buildDeterministicSessionReport(), buildSessionReportUserMessage() (+30 more)

### Community 6 - "Community 6"
Cohesion: 0.11
Nodes (35): getSqlClient(), clearDocumentProcessingJobsForTests(), createQueuePayload(), DocumentLookup, DocumentProcessingJob, DocumentProcessingJobStatus, DocumentProcessingWorkerResult, DocumentProcessingWorkerStatus (+27 more)

### Community 7 - "Community 7"
Cohesion: 0.11
Nodes (37): LearningTreeDetailResponse, LearningTreeOutlineResponse, parseJsonObject(), parseLearningTreeDetailResponse(), parseLearningTreeOutlineResponse(), parseLearningTreeResponse(), chunkConceptCandidateSchema, chunkConceptExtractionResponseSchema (+29 more)

### Community 8 - "Community 8"
Cohesion: 0.15
Nodes (23): bodySchema, Ctx, POST(), createRequestId(), logGenerateRoute(), POST(), InvalidTopicError, LlmExhaustedRetriesError (+15 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (33): Ctx, GET(), bundle, chunks, created, db, dbAbs, dbRel (+25 more)

### Community 10 - "Community 10"
Cohesion: 0.16
Nodes (33): asRecord(), buildDocumentEvidence(), ChunkCandidateBatch, ChunkConceptCandidate, ChunkConceptExtractionMetadata, clampDocumentScore(), conceptCandidateFromDocumentConcept(), consolidateConcepts() (+25 more)

### Community 11 - "Community 11"
Cohesion: 0.14
Nodes (33): getDb(), documentChunks, documentPages, bulkInsertDocumentChunks(), bulkInsertDocumentConcepts(), bulkInsertDocumentPages(), CreateDocumentInput, createDocumentLearningTreeLink() (+25 more)

### Community 12 - "Community 12"
Cohesion: 0.12
Nodes (28): buildFlowElements(), compareNodeKeys(), confidencePercent(), DocumentEvidenceItem, documentSourceTypeLabel(), documentSourceTypeTone(), edgeClassForNodeType(), edgeColorForNodeType() (+20 more)
...
Cohesion: 0.15
Nodes (25): Ctx, POST(), bodySchema, Ctx, PATCH(), createLearningNodes(), createLearningTree(), FullTreeOptions (+17 more)

### Community 15 - "Community 15"
Cohesion: 0.15
Nodes (19): Ctx, GET(), POST(), DocumentTreeContext, getDocumentForUser(), getDocumentLearningTreeForUser(), getDocumentTreeContextForUser(), listDocumentConceptsForUser() (+11 more)
...
Cohesion: 0.13
Nodes (23): AuthenticatedUserResult, AuthenticationFailureResult, authFailure(), extractBearerToken(), getSupabaseAuthApiKey(), getSupabaseUrl(), inferSupabaseUrlFromDatabaseUrl(), isUuid() (+15 more)

### Community 18 - "Community 18"
Cohesion: 0.16
Nodes (25): buildChunk(), chunkFromPdfPages(), chunkFromText(), ChunkInput, chunkUnits(), estimateTokens(), getOverlapUnits(), parseMarkdownHeadings() (+17 more)

### Community 19 - "Community 19"
Cohesion: 0.15
Nodes (26): ChatMessage, assembleLearningTree(), ChatCompletionRunner, classifyLlmError(), DETAIL_PHASES, DetailPhase, fallbackConceptCandidate(), GenerateLearningTreeOptions (+18 more)

### Community 20 - "Community 20"
Cohesion: 0.13
Nodes (25): applySelfAssessment(), clampScore(), INITIAL_CONFIDENCE_BY_STATUS, initialConfidenceForStatus(), MasteryStatus, SelfAssessmentResult, Ctx, ensureConcept() (+17 more)
...
Cohesion: 0.16
Nodes (21): Home(), ALLOWED_DOCUMENT_EXTENSIONS, apiErrorMessage(), DocumentConceptsResponse, DocumentConceptSummary, documentProcessingStage(), DocumentProcessingStatus, DocumentStatusResponse (+13 more)

### Community 26 - "Community 26"
Cohesion: 0.14
Nodes (22): bodySchema, llmErrorResponse(), POST(), convertScoreToStatus(), shouldNeedReview(), applyQuizResultToMastery(), buildQuizEvaluationUserMessage(), evaluateQuizAnswerWithLlm() (+14 more)

### Community 27 - "Community 27"
Cohesion: 0.18
Nodes (16): AdminConceptsPage(), firstParam(), isAdminRouteEnabled(), PageProps, short(), StatusBadge(), globalForDb, resolvePostgresConnectionString() (+8 more)

### Community 28 - "Community 28"
Cohesion: 0.09
Nodes (22): 17. 품질 기준, 18. 최소 품질 기준, 1. Phase 4 목표, 1순위, 20. 구현 우선순위, 21. 보안 및 개인정보 고려, 22. Phase 4 완료 조건, 23. Phase 4의 핵심 판단 기준 (+14 more)

### Community 29 - "Community 29"
Cohesion: 0.1
Nodes (19): 15. 사용자 진행 상태 확장, 17. 품질 기준, 1. Phase 2 목표, 20. Phase 2 완료 조건, 21. Phase 2의 핵심 판단 기준, 2. Phase 2의 위치, 3. Phase 2 범위, 4. Phase 1과 Phase 2의 차이 (+11 more)

### Community 30 - "Community 30"
Cohesion: 0.19
Nodes (13): generateLearningTree(), formatConceptsForPrompt(), searchConceptsForPromptContext(), createFullLearningTree(), assert(), main(), node(), setupDb() (+5 more)
...
Cohesion: 0.26
Nodes (15): ConceptRow, DocumentTreeNodeContext, LearningNodeRow, saveNodeDetail(), buildPanelGraph(), buildPrerequisitePromptContext(), documentContextToApi(), DocumentNodeDetailGenerator (+7 more)
...
Cohesion: 0.17
Nodes (15): ApiPersonalizedNode, ApiPersonalizedRecommendationItem, ApiPersonalizedRecommendationsResponse, ApiPersonalizedTreeResponse, ApiProgressEntry, ApiReviewDueResponse, ApiReviewItem, ApiSessionReportResponse (+7 more)
...
Cohesion: 0.31
Nodes (15): resetDbSingleton(), cleanupSmokeDb(), assert(), assertAllNodesLinked(), attentionFamilyTree(), bertTree(), cleanupSmokeDb(), EdgeSpec (+7 more)
...
Cohesion: 0.23
Nodes (13): bodySchema, POST(), isLearningEventType(), LEARNING_EVENT_TYPES, LearningEventType, toIsoString(), getDocumentAccessForUser(), getLearningNodeScopeForUser() (+5 more)
...
Cohesion: 0.26
Nodes (12): communityMembers, conceptCommunities, conceptEdges, conceptMergeCandidates, concepts, documentConcepts, documentLearningTrees, documents (+4 more)
...
Cohesion: 0.17
Nodes (11): 10. UI 요구사항, 13. 구현 우선순위, 14. Phase 1 완료 조건, 15. Phase 1의 핵심 판단 기준, 1. Phase 1 목표, 1순위, 2순위, 3순위 (+3 more)
...
Cohesion: 0.44
Nodes (9): getOpenRouterMaxAttempts(), classifyLlmError(), generateDocumentTreeStructure(), GenerateDocumentTreeStructureOptions, logGenerate(), shouldAbortRetries(), parseDocumentTreeStructureResponse(), buildDocumentTreeStructureUserMessage() (+1 more)
...
Cohesion: 0.44
Nodes (8): assertValidRefs(), communityId(), ConceptCommunityView, ConceptGraphInputNode, DerivedConceptGraphNode, DerivedConceptGraphView, deriveDepths(), deriveLearningGraphView()
...
Cohesion: 0.46
Nodes (6): DetailLearningBlocks(), DetailLearningBlocksProps, firstSentence(), ApiNodeDetailResponse, ApiLearningNode, NodeType

### Community 76 - "Community 76"
Cohesion: 0.29
Nodes (4): byId, graph, nodes, buildDeepDiveGenerationTopic()
...
Cohesion: 0.38
Nodes (5): generationStageMessage(), statusIcon(), TreePageClient(), Props, TreePage()
...
Cohesion: 0.53
Nodes (5): assert(), dbAbs, dbRel, main(), requireOpenRouterEnv()
...
Cohesion: 0.7
Nodes (3): GenerationLoadingPanel(), GenerationLoadingPanelProps, waitHint()
...
Cohesion: 0.67
Nodes (3): 12. LLM 출력 스키마 변경, code:json ({), Phase 2 학습 트리 생성 응답 스키마

### Community 118 - "Community 118"
Cohesion: 0.67
Nodes (3): 2. Phase 4의 위치, code:text (Phase 1: 주제 입력 기반 선수지식 트리 MVP), code:text (Phase 1의 학습 트리)
...
- **Why does `getDb()` connect `Community 11` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 9`, `Community 10`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 20`, `Community 24`, `Community 26`, `Community 27`, `Community 30`, `Community 32`, `Community 36`, `Community 38`, `Community 41`, `Community 49`, `Community 90`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `jsonError()` connect `Community 17` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 38`, `Community 8`, `Community 41`, `Community 9`, `Community 14`, `Community 15`, `Community 20`, `Community 24`, `Community 26`, `Community 27`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `NodeType` connect `Community 75` to `Community 32`, `Community 34`, `Community 3`, `Community 67`, `Community 37`, `Community 36`, `Community 12`, `Community 76`, `Community 14`, `Community 19`, `Community 24`, `Community 30`?**
