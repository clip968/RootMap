# Graph Report - RootMap  (2026-05-21)

## Corpus Check
- 114 files · ~71,455 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1925 nodes · 4804 edges · 127 communities (123 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 35 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c4d185fb`
...
Cohesion: 0.07
Nodes (72): Ctx, GET(), PATCH(), patchSchema, baseSlugFromNormalizedTitle(), normalizeTitle(), AdminConceptsPage(), firstParam() (+64 more)
...
Cohesion: 0.13
Nodes (50): llmProviderSettings, ChatMessage, ChatRole, createChatCompletion(), getOpenRouterTimeoutMs(), OpenRouterChatCompletionResponse, OpenRouterChoiceMessage, buildChatCompletionsUrl() (+42 more)
...
Cohesion: 0.15
Nodes (37): CompleteUploadRequest, POST(), ALLOWED_DOCUMENT_MIME_TYPES, documentTitleFromFilename(), EXECUTABLE_EXTENSIONS, EXECUTABLE_MIME_PREFIXES, extensionOf(), isAllowedMime() (+29 more)
...
Cohesion: 0.1
Nodes (36): bodySchema, llmErrorResponse(), POST(), applySelfAssessment(), clampScore(), convertScoreToStatus(), INITIAL_CONFIDENCE_BY_STATUS, initialConfidenceForStatus() (+28 more)
...
Cohesion: 0.14
Nodes (24): bodySchema, Ctx, POST(), createRequestId(), logGenerateRoute(), POST(), InvalidTopicError, LlmExhaustedRetriesError (+16 more)

### Community 10 - "Community 10"
Cohesion: 0.14
Nodes (36): userNodeProgress, asRecord(), buildDocumentEvidence(), ChunkCandidateBatch, ChunkConceptCandidate, ChunkConceptExtractionMetadata, clampDocumentScore(), conceptCandidateFromDocumentConcept() (+28 more)

### Community 11 - "Community 11"
Cohesion: 0.11
Nodes (32): buildFlowElements(), compareNodeKeys(), DocumentEvidenceItem, documentSourceTypeLabel(), documentSourceTypeTone(), edgeClassForNodeType(), edgeColorForNodeType(), FOCUS_OPTIONS (+24 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (34): Ctx, GET(), getDocumentConceptEvidenceForUser(), bundle, chunks, created, db, dbAbs (+26 more)
...
Cohesion: 0.16
Nodes (22): userConceptProgress, bodySchema, Ctx, PATCH(), createLearningNodes(), createLearningTree(), FullTreeOptions, getConceptTreeUsageCounts() (+14 more)
...
Cohesion: 0.07
Nodes (27): AppendLearningEventInput, CreateLearningReportInput, CreateMisconceptionEventInput, CreateQuizAttemptInput, CreateRecommendationLogInput, DocumentAccessRow, GetDocumentAccessInput, GetLearningNodeScopeInput (+19 more)
...
Cohesion: 0.16
Nodes (20): bodySchema, Ctx, paramsSchema, POST(), readOptionalJson(), bodySchema, POST(), isLearningEventType() (+12 more)

### Community 23 - "Community 23"
Cohesion: 0.08
Nodes (22): 12. LLM 출력 스키마 변경, 15. 사용자 진행 상태 확장, 17. 품질 기준, 1. Phase 2 목표, 20. Phase 2 완료 조건, 21. Phase 2의 핵심 판단 기준, 2. Phase 2의 위치, 3. Phase 2 범위 (+14 more)
...
Cohesion: 0.09
Nodes (21): 18. 최소 품질 기준, 1. Phase 4 목표, 21. 보안 및 개인정보 고려, 22. Phase 4 완료 조건, 23. Phase 4의 핵심 판단 기준, 2. Phase 4의 위치, 3. Phase 4 범위, 4. Phase 3와 Phase 4의 차이 (+13 more)

### Community 26 - "Community 26"
Cohesion: 0.16
Nodes (16): byDifficultyAsc(), byDocumentOrderThenDifficulty(), RecommendNextOptions, RecommendNodeInput, assert(), assertConcurrencyLimit(), assertThrows(), documentNodes (+8 more)

### Community 27 - "Community 27"
Cohesion: 0.16
Nodes (16): AuthenticatedUserResult, AuthenticationFailureResult, authFailure(), extractBearerToken(), getSupabaseAuthApiKey(), getSupabaseUrl(), inferSupabaseUrlFromDatabaseUrl(), isUuid() (+8 more)
...
Cohesion: 0.25
Nodes (16): ConceptRow, DocumentTreeNodeContext, findDocumentContextForNode(), LearningNodeRow, saveNodeDetail(), buildPanelGraph(), buildPrerequisitePromptContext(), documentContextToApi() (+8 more)

### Community 30 - "Community 30"
Cohesion: 0.22
Nodes (15): POST(), getDocumentForUser(), getDocumentLearningTreeForUser(), assert(), checkQuality(), db, dbAbs, dbRel (+7 more)
...
Cohesion: 0.25
Nodes (13): DocumentTreeContext, ApiTreeResponse, ApiLearningNode, ApiProgressEntry, ApiTreePayload, ChunkConceptCandidate, ConceptRelationType, ConsolidatedConcept (+5 more)

### Community 33 - "Community 33"
Cohesion: 0.26
Nodes (13): classifyLlmError(), generateChunkConcepts(), GenerateChunkConceptsOptions, GenerateChunkConceptsResult, logGenerate(), shouldAbortRetries(), parseChunkConceptExtractionResponse(), buildDocumentChunkConceptUserMessage() (+5 more)
...
Cohesion: 0.24
Nodes (14): createDocument(), assert(), createTestPdf(), db, dbAbs, dbRel, extractAndChunkDocument(), ExtractSmokeError (+6 more)
...
Cohesion: 0.25
Nodes (11): byId, graph, nodes, assertValidRefs(), communityId(), ConceptCommunityView, ConceptGraphInputNode, DerivedConceptGraphNode (+3 more)
...
Cohesion: 0.21
Nodes (12): resetDbSingleton(), assert(), dbAbs, dbRel, main(), requireOpenRouterEnv(), db, dbAbs (+4 more)
...
Cohesion: 0.36
Nodes (8): generateLearningTree(), formatConceptsForPrompt(), searchConceptsForPromptContext(), createFullLearningTree(), GenerateAndPersistOptions, generateAndPersistTree(), logGenerateService(), validateTopicInput()

### Community 56 - "Community 56"
Cohesion: 0.41
Nodes (8): Ctx, POST(), getDocumentTreeContextForUser(), getLearningTree(), getOrCreateNodeDetailForRequest(), bundleToApiTreeResponse(), Ctx, GET()
...
Cohesion: 0.44
Nodes (8): generateNodeDetail(), GenerateNodeDetailInput, GenerateNodeDetailResult, shouldAbortRetries(), parseNodeDetailResponse(), buildNodeDetailUserMessage(), nodeDetailQualityWarnings(), NodeDetailResponse
...
Cohesion: 0.33
Nodes (8): calculateReviewPriorityScore(), quizErrorScore(), recencyDecayScore(), ReviewCandidate, ReviewItem, ReviewPriorityInput, reviewReasons(), roundScore()
...
Cohesion: 0.52
Nodes (5): DetailLearningBlocks(), DetailLearningBlocksProps, firstSentence(), ApiNodeDetailResponse, NodeType
...
Cohesion: 0.57
Nodes (5): recommendNextNodes(), Ctx, GET(), getConceptProgressMapForUser(), DocumentNodeType
...
Cohesion: 0.67
Nodes (3): 17. 품질 기준, 기능 검증 기준, 품질 검증 기준
...
## Knowledge Gaps
- **529 isolated node(s):** `ReportConceptContext`, `ReportLearningEventInput`, `ReportMasteryRecordInput`, `ReportQuizAttemptInput`, `ReportMisconceptionEventInput` (+524 more)
...
- **Why does `getDb()` connect `Community 13` to `Community 0`, `Community 2`, `Community 6`, `Community 7`, `Community 10`, `Community 12`, `Community 16`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 27`, `Community 29`, `Community 30`, `Community 35`, `Community 42`, `Community 47`, `Community 55`, `Community 56`, `Community 87`, `Community 88`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `jsonError()` connect `Community 0` to `Community 2`, `Community 4`, `Community 6`, `Community 88`, `Community 9`, `Community 12`, `Community 16`, `Community 20`, `Community 22`, `Community 56`, `Community 27`, `Community 30`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `ProgressStatus` connect `Community 26` to `Community 32`, `Community 6`, `Community 7`, `Community 11`, `Community 16`, `Community 18`, `Community 20`, `Community 21`?**
...
- **What connects `ReportConceptContext`, `ReportLearningEventInput`, `ReportMasteryRecordInput` to the rest of the system?**
