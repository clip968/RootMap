...
- Phase 06 live smoke creates user A and user B, seeds user B rows, then verifies user A cannot read or update them.
...
- Legacy text `user_id` tables still need long-term UUID migration or mapping.
