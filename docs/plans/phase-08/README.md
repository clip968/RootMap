...
- [x] 01. [01-client-single-detail-request.md](./01-client-single-detail-request.md) - 클라이언트 detail 요청 단일화와 즉시 로딩 상태 적용
- [x] 02. [02-server-cache-and-concept-fast-path.md](./02-server-cache-and-concept-fast-path.md) - 서버 cache/Concept fast path 추가
- [x] 03. [03-panel-graph-query-optimization.md](./03-panel-graph-query-optimization.md) - concept graph 보강 조회 최적화
- [x] 04. [04-detail-latency-observability-and-quality-gate.md](./04-detail-latency-observability-and-quality-gate.md) - duration 로그와 최종 품질 gate 적용
